define(function(require, exports, module) {
    ...
    var buttonHtml = '<div id="buttonContent" class="fade modal" role="dialog" tabindex="-1"><div class="modal-dialog" role="document"><div class="modal-content"><div class="modal-header"><button class="close" type="button" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">×</span></button><h4 class="modal-title" >Insert Button</h4></div><div class="modal-body"><p><form><div class="form-group"><label for="buttonTitle">Enter Button Label</label><input class="form-control input-lg" id="buttonTitle" placeholder="Button Label" type="input" /><label for="buttonSearch">Search Buttons by Type</label><input class="form-control input-lg" id="buttonSearch" placeholder="Button" type="input" /></div><div id="buttonResult"></div></form></p></div><div class="modal-footer"><button class="btn btn-default" type="button" data-dismiss="modal">Close</button><button class="btn btn-primary" type="button" id="buttonInsert">Insert</button></div></div></div></div>';
    var modalCSS = '.cke_maximized {z-index: 9996 !important;}.cke_button__globalcontent_icon, .cke_button__legalcontent_icon, .cke_button__fleschkincaid_icon, .cke_button__buttoncontent_icon {display: none !important;}.cke_button__globalcontent_label, .cke_button__legalcontent_label, .cke_button__fleschkincaid_label, .cke_button__buttoncontent_label {display: inline !important;padding: 0px;margin: 0px;}.modal.fade, .modal-scrollable {z-index: 9998 !important;}span#modalID {font-size: 11px;font-style: italic;}.autocomplete-suggestions {border: 1px solid #999;background: #FFF;overflow: auto;z-index: 9999 !important;}.autocomplete-suggestion {padding: 2px 5px;white-space: nowrap;overflow: hidden;}.autocomplete-selected {background: #F0F0F0;}.autocomplete-suggestions strong {font-weight: normal;color: #3399FF;}.autocomplete-group {padding: 2px 5px;}.autocomplete-group strong {display: block;border-bottom: 1px solid #000;}';
    var $ = require("jquery");
    var uri = module.uri;
